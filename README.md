...
The plugin version tracks the wcstack release the content was last verified against (currently **2.6.1**). The `SKILL.md` frontmatter carries the same stamp as `metadata.wcstack-version`.
