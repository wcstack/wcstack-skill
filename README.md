...
The plugin version tracks the wcstack release the content was last verified against (currently **1.24.0**). The `SKILL.md` frontmatter carries the same stamp as `metadata.wcstack-version`.
